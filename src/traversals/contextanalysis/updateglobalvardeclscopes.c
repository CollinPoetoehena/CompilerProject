...
//     //isUpdating = false;
//     struct data_ugvs *data = DATA_UGVS_GET();
//     bool *varneedsToUpdateBoolInHashTable = (bool *) HTlookup(data->assign_var_occurred, VARLET_NAME(node));
//     if (varneedsToUpdateBoolInHashTable != NULL) {
//         *varneedsToUpdateBoolInHashTable = false;
//     }
...
//         bool *varNeedsToUpdate = (bool *) HTlookup(data->assign_var_occurred, VAR_NAME(node));
...
//                 HTinsert(data->assign_var_occurred, VAR_NAME(node), (void *) true);
//             }
//         } else if (varNeedsToUpdate != NULL && varNeedsToUpdate) {
//             printf("THIS ALSO NEEDS TO UPDATE IT!\n");
//             node_st *globalSteLinkVar = findSteNodeInGlobalSteChain(VAR_NAME(node));
//             // If it is not in the global chain, not update the link
//             if (globalSteLinkVar != NULL) {
//                 printf("LINK UPDATED!********************\n");
